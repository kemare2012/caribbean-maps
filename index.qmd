...
# Create the map
ggplot() +
  geom_sf(data = caribbean, fill = "skyblue", color = "black", size = 0.2) + # Base map
  geom_sf(data = highlighted_data, fill = "orange", color = "black", size = 0.2) + # Highlighted island
...
geom_text_repel(data = highlighted_data, 
                   ...
                   box.padding = 0.5, # Adjust padding around label
  ...
  coord_sf(xlim = c(-65, -60), ylim = c(10, 20), expand = TRUE) +  # Zoom in, adjust as needed
